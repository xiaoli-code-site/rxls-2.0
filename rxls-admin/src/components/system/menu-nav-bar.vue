  ...
  >
    ...
    >
      <div class="header">
        ...
        >
          <!-- 图标 -->
          <img class="logo" src="/src/assets/logo.png" alt="软星系统" />
          <h4 class="title" v-if="!state.collapsed">
        ...
        >
          ...
          >
            <a-tooltip v-if="!state.collapsed">
              ...
              <MenuFoldOutlined :style="{ fontSize: '17px' }" />
            </a-tooltip>
...
watch(
  () => route.path,
  (_val, _oldVal) => {
    userStore.selectedMenu = route.path;
  }
);
