<template>
  <div class="rx_table_box">
    ...
    <a-modal
      :width="props.fullModal ? '100%' : '520px'"
      :wrap-class-name="props.fullModal ? 'full-modal' : ''"
      :centered="true"
      :destroyOnClose="true"
      v-model:open="openModal"
      :title="alterMode ? t(`common.detail`) : t(`common.add`)"
...
import RxLoading from "@/components/common/loading/RxLoading.vue";
 ...
 * 内容的显示大小
 */
const contentSize = ref<string>("small");
