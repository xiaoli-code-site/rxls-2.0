...
export default {
  ...
  common: {
    ...
    managementSystem: "Soft Star Admin", //管理系统
  ...
  home: {
    ...
    thisYearOrderStatistics: "This year's order statistics", //今年订单统计
  },
  ...
  user: {
    ...
    bornNoEmpty: "born no empty", //出生日期不为空
  },
   ...
   */
  menu: {
    permission: "Permission Admin", //权限管理
    category: "Category Admin", //分类管理
    afterSales: "AfterSales Admin", //售后管理
    share: "Share Admin", //分享管理
    ad: "Ad Admin", //推广管理
    publicize: "Publicize Admin", //宣传管理
    brand: "Brand Admin", //品牌管理
    commodity: "Commodity Admin", //商品管理
    payment: "Payment Records", //支付记录
    order: "Order Admin", //订单管理
    product: "Product Admin", //商品管理
    task: "Task Admin", //任务管理
  ...
  message: {
    ...
    imageNotEmpty: "The image is not empty", //图片不为空
    amountNotEmpty: "The amount is not empty", //金额不为空
    incorrectAmountFormat: "Incorrect amount format", //错误的金额格式
    ...
    videoNotEmpty: "video not empty", //视频不为空
    contentNotEmpty: "content not empty", //内容不为空
    specificationNotEmpty: "specification not empty", //规格不为空
    categoryNotEmpty: "category not empty", //类型不为空
    useFullScreenModeForBetterEditingExperience:
      "Use full screen mode for better editing experience!", //编辑时使用全屏模式以获取更好的体验
  },
  ...
  bth: {
    all: "All", //全部
    exchangeGoods: "Exchange Goods", //换货
    refuse: "Refuse", //拒绝
    cancel: "Cancel", //取消
    adopt: "Adopt", //通过
    logisticsDetails: "Log Details", //物流详情
    view: "View", //查看
    ship: "Ship", //发货
    detail: "Detail", //详情
    close: "Close", //关闭
